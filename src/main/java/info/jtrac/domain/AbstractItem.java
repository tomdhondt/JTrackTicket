...
//import static main.java.info.jtrac.domain.Field.Name.*;
...
public abstract class AbstractItem implements Serializable{   
	 ...
	 * Serial Version ID
	 */
	private static final long serialVersionUID = -8515101455165440433L;
	@Id
	...
	@ManyToOne(cascade = CascadeType.REFRESH, fetch=FetchType.EAGER)
	@JoinColumn(name = "LOGGEDBY_ID",nullable=true)
	...
	@OneToMany(cascade=CascadeType.REFRESH, fetch=FetchType.EAGER)
	@JoinColumn(name = "RELATEDITEM_ID", nullable=true)
    private Set<ItemItem> relatedItems;
//	@OneToMany(cascade=CascadeType.REFRESH, fetch=FetchType.EAGER)
//	@JoinColumn(name = "RELATINGITEM_ID", nullable=true)
	@Transient
